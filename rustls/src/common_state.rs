...
use crate::msgs::handshake::{CertificateChain, HandshakeMessagePayload, Random};
...
pub struct CommonState {
    ...
    /// Attested TLS related config
    /// 
    /// Client in an enclave
    pub(crate) client_attest: bool,
    /// Server in an enclave
    pub(crate) server_attest: bool,
    /// randem generated by client for server to produce evidence
    pub(crate) client_evidence_random: Random,
    /// randem generated by server for client to produce evidence
    pub(crate) server_evidence_random: Random,
}
...
impl CommonState {
    pub(crate) fn new(side: Side) -> Self {
        Self {
            ...
            client_attest: false,
            server_attest: false,
            client_evidence_random: Random([0u8; 32]),
            server_evidence_random: Random([0u8; 32]),
        }
    }
