...
enum_builder! {
    ...
    pub enum ExtensionType {
        ...
        EvidenceProposals => 0xf000, // Fake IANA number: https://datatracker.ietf.org/doc/draft-fossati-tls-attestation/
        EvidenceRequests => 0xf001,
        EvidenceRandom => 0xf002,
    }
}
...
// Define extra Enum for attested TLS
enum_builder! {
    /// The `EvidenceProposal` TLS protocol enum.  Values in this enum are taken fake values we put here outselves
    #[repr(u8)]
    pub enum EvidenceProposal {
        NoProposal => 0x00,
        AWSAttestation => 0x01,
    }
}
...
enum_builder! {
    /// The `EvidenceRequest` TLS protocol enum.  Values in this enum are taken fake values we put here outselves
    #[repr(u8)]
