...
pub enum PeerMisbehaved {
    ...
    ClientMissingEvidenceRequest,
    ClientMissingEvidenceProposal,
    ClientMissingEvidenceRandom,
    ...
    ServerMissingEvidenceRequest,
    ServerMissingEvidenceProposal,
    ServerMissingEvidenceRandom,
